...
export function CreateWorkoutMuscles() {
  ...
  return (
    <div className="bg-[#202020] fixed inset-0 overflow-hidden flex items-center justify-center" data-name="criar-treino-03">
        ...
        <div className="flex-1 flex items-center justify-center min-h-0">
          <div className="w-full space-y-6">
            ...
            <div className="text-center">
              <p className="font-alexandria font-normal text-[20px] sm:text-[24px] text-white">
              ...
              <div className="grid grid-cols-4 gap-2">
                {['Peito', 'Costas', 'Ombros', 'Braços'].map((muscle) => (
                  <button
                    ...
                    className={`h-[45px] sm:h-[50px] rounded-[999px] flex items-center justify-center transition-all ${
                      selectedMuscles.includes(muscle)
                        ? 'bg-[#1c1c1c] text-white'
                        : 'bg-[rgba(61,61,61,0.5)] text-white/70 hover:bg-[rgba(61,61,61,0.7)]'
                    }`}
                  >
                    <p className="font-alexandria font-normal text-[11px] sm:text-[12px]">{muscle}</p>
                  </button>
                ))}
              </div>
