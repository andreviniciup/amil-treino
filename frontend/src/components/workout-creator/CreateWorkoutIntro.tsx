...
export function CreateWorkoutIntro() {
  ...
  return (
    <div className="bg-[#202020] fixed inset-0 overflow-hidden flex items-center justify-center" data-name="criar-treino-01">
      <div className="relative w-full max-w-[393px] h-full flex flex-col px-5 py-6">
        ...
        <div className="w-full pt-5 pb-3">
          ...
          >
            <p className="font-alexandria font-medium text-[18px] sm:text-[20px] text-white">Começar</p>
          </button>
        </div>
      </div>
    </div>
