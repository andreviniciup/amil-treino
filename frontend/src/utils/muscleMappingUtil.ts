/**
 * Utilitário de Mapeamento de Músculos PT-EN (Frontend)
 * 
 * Este utilitário fornece mapeamento bidirecional entre nomes de músculos
 * em português e inglês para garantir consistência nas chamadas de API
 */

export class MuscleMappingUtil {
